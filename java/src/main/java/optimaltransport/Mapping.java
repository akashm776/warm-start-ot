...
public class Mapping {
	 ...
	 */
	public Mapping(int n, double[] supplies, double[] demands, double[][] C, double delta) { // TODO - Needs parameter dual_weights - Initial Dual Weights
		...
		GTTransport gt = new GTTransport(scaledC, scaledSupplies, scaledDemands, n); // TODO - Needs to pass in the dual_weights got from mapping
		...
		System.out.println("GTTransport without warm starts " + gt.toString());
